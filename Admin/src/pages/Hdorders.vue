  ...
  <div class="content">
    ...
    <div v-if="!preloader">
      ...
      <template v-for="(order,index) in orders">
        <f7-block-title style="margin-top:15px"><h5 class="mpzero">ORDER NO : {{ order.order_id }}</h5></f7-block-title>
                ...
                <f7-block style="margin:0px">
                  ...
                  <div style="color:gray">
                    ...
                    <f7-row style="color:rgb(97, 97, 97);font-weight:800">
                      ...
                      <f7-col style="text-align:right">
                        <p class="mpzero" style="padding-top:8px">RS.{{total_selling[index] - order.cashback }}</p>
                      </f7-col>
                    </f7-row>
                  </div>
                </f7-block>
