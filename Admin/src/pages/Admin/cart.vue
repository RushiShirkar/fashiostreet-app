  ...
  <div>
    <div class="row marginzero" style="position: fixed;width: 100%;top:0px;left:0px;">
      <div class="col-md-11 " style="border-right: 1px solid #FFFFFF">
        <a href="javascript:void(0)" class="rep_tab">HD Cart Msg</a>
      </div>
    ...
    <div class="row marginzero" style="margin-top: 60px">
      <div class="col-lg-2 col-md-2 col-sm-2 sidebar">
        <ul class="list-unstyled">
          ...
          <li style="background-color: red;"><a style="font-size:20px">Hd Cart Msg<span class="glyphicon glyphicon-menu-right pull-right menu_arrow"></span></a></li>
