  ...
  <f7-page>
    <div class="row marginzero" style="position: fixed;width: 100%;top:0px;left:0px;">
      <div class="col-md-11 " style="border-right: 1px solid #FFFFFF">
        <a href="javascript:void(0)" class="rep_tab" style="font-size:14px">All Customers Msg</a>
      </div>
    ...
    <div class="row marginzero" style="margin-top: 60px">
      <div class="col-lg-2 col-md-2 col-sm-2 sidebar">
        <ul class="list-unstyled">
          <li style="background-color: red;"><a style="font-size:20px">All Customers<span class="glyphicon glyphicon-menu-right pull-right menu_arrow"></span></a></li>
          ...
          <li><a style="font-size:20px" href="/call">Call / Chat / Whatsapp Msg<span class="glyphicon glyphicon-menu-right pull-right menu_arrow"></span></a></li>
          <li><a style="font-size:20px" href="/wallet">Wallet Msg<span class="glyphicon glyphicon-menu-right pull-right menu_arrow"></span></a></li>
        </ul>
      </div>
      <div style="float:right;width:60%;margin-left:150px">
        <div>
        ...
        <a class="link external" href="https://wa.me/?text=urlencodedtext" style="height:100%;margin-top:20px">Whatsapp</a>
      </div>
    </div>
    </f7-page>
  </div> 
