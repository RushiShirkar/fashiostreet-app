<template>
    ...
    <f7-page login-screen>
      ...
      <f7-list>
        <f7-list-item> <f7-button @click="send" style="width:100%;background-color:#273657" fill big :disabled="status">{{ btn_text }}</f7-button></f7-list-item>
      </f7-list>
      ...
      <f7-list>
        <f7-list-item> <f7-button @click="reset" style="width:100%;background-color:#273657" fill big >RESET PASSWORD</f7-button></f7-list-item>
      </f7-list>
      </div>
      </div>
      <div v-else>
          ...
          <f7-button style="width:100%;background-color:#273657" fill big href="/login/">LOGIN</f7-button>
        </f7-block>
      </div>
      </f7-block>
    </f7-page>
