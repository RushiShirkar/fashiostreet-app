...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::post('feedback','fashiostreet\product\UserController@saveFeedback');
    ...
    Route::post('sendReferalMsg','fashiostreet\product\UserController@sendReferalMsg');
    ...
    Route::group(['middleware' => 'checkAuthOut'],function (){
        Route::prefix('/user')->group(function(){
            ...
            Route::get('/address/{json?}','fashiostreet\product\AddressController@getAddress');

            Route::post('/deleteaddress','fashiostreet\product\AddressController@deleteAddress');

            Route::post('/editAddress','fashiostreet\product\AddressController@editAddress');

            Route::post('/addAddress','fashiostreet\product\AddressController@addAddress');
            ...
            Route::post('/placeOrder','fashiostreet\product\OrderController@addOrder');
