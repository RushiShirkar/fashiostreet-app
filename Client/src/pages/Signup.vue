<template>
      ...
      <f7-list>
<f7-list-item> <f7-button @click="signin" style="width:100%;background-color:#273657" fill big login-screen-close :disabled="status">{{ btn_name }}</f7-button></f7-list-item>
     ...
     <div v-else>
        <f7-block style="padding-top:100px;margin:0px;text-align:center">
          ...
          <f7-button style="width:100%;background-color:#7fff00" fill big href='/activateuser/'>ACTIVATE ACCOUNT</f7-button>
